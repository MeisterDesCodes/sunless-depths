...
enum cardType {MELEE_DAMAGE, RANGED_DAMAGE, ATTACK_DELAY, HEALTH, MOVEMENT_SPEED, STAMINA_COST, SIGHT, FORTUNE, EFFECT_STRENGTH, CRITICAL_DAMAGE, DANGER, \
	MELEE_RANGED, THIRD_ATTACK, KNOCKBACK, PROJECTILE_SPREAD_SPEED, KILL_ATTACK_DELAY_SPEED, KILL_STAMINA, EXHAUSTING_ATTACK, SIGHT_RADIUS_ENTRY, CONSUME_AMMO, DAMAGE_RANGE, EFFECT_DURATION, EFFECT_TAKEN_DURATION, CRIT_CHANCE, CRIT_STAT_INCREASE}
...
enum inventoryType {REGULAR, CRAFTING, STORAGE_PLAYER, STORAGE_BOX}
